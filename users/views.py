...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, f'Ваша учетная запись была создана! Теперь вы можете войти в систему')
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            'content'], 'smtp.gmail.com', ['seven6496@gmail.com'], fail_silently=False)
            if mail:
